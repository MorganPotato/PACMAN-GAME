...
def resource_path(relative_path):
    """Obtén la ruta absoluta a un recurso, considerando PyInstaller."""
    if hasattr(sys, '_MEIPASS'):
        # Si está empaquetado con PyInstaller, busca en _MEIPASS
        return os.path.join(sys._MEIPASS, relative_path)
    # Si no está empaquetado, usa la ruta relativa
...
pacman_image = pygame.image.load("Pacman.png")  # Add the correct path to your Pacman PNG
pacman_image = pygame.transform.scale(pacman_image, (CELL_SIZE, CELL_SIZE))

ghost_image = pygame.image.load("fantasma.png")  # Add the correct path to your Ghost PNG
